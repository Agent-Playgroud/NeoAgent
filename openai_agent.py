...
# Inicializar FastAPI
app = FastAPI()  # Isso deve estar aqui, conforme o erro diz que não foi encontrado
...
def recomendar(chat_request: ChatRequest):
    ...
    resposta_assistente, st.ssesion_state["messages"] = chat_with_openai(chat_request.mensagem, st.session_state["messages"])
