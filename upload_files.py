...
if documento is not None:
    ...
    subpasta = "agentes/Agente 1"   #>>>PRECISAR DE ALTERAR PARA O NOME DO AGENTE NA REFERENCIA DO BANCO DE DADOS<<<
    ...
    functions_bd.inserir_arquivo(1,documento.name,1)  #>>>PRECISAR DE ALTERAR PARA O ID DO AGENTE E DO USER NA REFERENCIA DO BANCO DE DADOS<<<
